...
<script type="text/javascript" src="<?php echo base_url('assets/bower_components/bootstrap-sass/assets/javascripts/bootstrap.min.js')?>"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/javascripts/lib/jquery.fittext.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/javascripts/lib/jquery.activeNavigation.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/javascripts/lib/spectrum.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/javascripts/global.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/javascripts/dashboard.js')?>"></script>
