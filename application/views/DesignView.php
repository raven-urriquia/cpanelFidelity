                        ...
                        <div class="col-md-4">
                            <div class="row left">
                                <div class="col-md-12 clearfix uploadLogo">
                                    <h5 class="withIco"><img src="assets/images/oneIco.jpg" alt="">Upload Logo</h5>
                                ...
                                <div class="col-md-12 clearfix addBackImage">
                                    <h5 class="withIco"><img src="assets/images/twoIco.jpg" alt="">Add Background Image</h5>
                                    <img src="assets/images/addImage.jpg" class="imgPrev" alt="">
                                    <div class="pull-left">
                                    <span class="btn btn-default btn-file">
                                    Choose File <input type="file">
                                ...
                                <div class="col-md-12 clearfix choosePalete">
                                    <h5 class="withIco"><img src="assets/images/threeIco.jpg" alt="">Choose Color Palete</h5>
                                    <div class="row">
                                        <div class="col-md-12">
                                ...
                                <div class="col-md-12 clearfix upStampC">
                                    <h5 class="withIco"><img src="assets/images/twoIco.jpg" alt="">Upload Stamp Design</h5>
                    ...
                    <div class="cardTab">
                        <div class="col-md-4">
                            <div class="row left">
                                ...
                                <div class="col-md-12 clearfix cardAddBackColor">
                                    <h5 class="withIco"><img src="assets/images/threeIco.jpg" alt="">Choose Background Color</h5>
                                    <div class="hexwrap">
                        ...
                        <div class="col-md-8 right">
                            <div class="cardFrame">
                                <div class="cardWrap">
                                    <div class="overlay">
                                        <img src="assets/images/cardLogo.png" class="cardLogo" alt="">
                                        <img src="assets/images/qr.png" alt="" class="qr">
                                    </div>
                                </div><!--cardWrap-->
                            </div><!--cardFrame-->
                        </div><!--right-->
