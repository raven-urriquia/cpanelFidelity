        ...
        <div id="content" class="promos spacing">
                <div class="noTab">
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <h5 class="withIco"><img src="assets/images/oneIco.jpg" alt=""> Create Card Stamp</h5>
                      </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="withIco"><img src="assets/images/twoIco.jpg" alt=""> Add Earning & Reward</h5>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="prodWrap">
                                        <div class="col-md-1 col-sm-6">
                                            <a href=""><img src="assets/images/addImage.jpg" class="imgPrev" alt=""></a>
                                        </div>
